...
<template>
    <div id="page">
        <div id='main'>
            <router-link to="/choiceEmployee"><mt-field label="离职员工" :placeholder="employeeName" v-model="employeeName" disabled>
                <img src="@/assets/img/right.png" height="12px" width="8px">
            </mt-field></router-link>
            <mt-field label="所属业务区" placeholder="系统自动带出" v-model="employeeArea" disabled></mt-field>
            <mt-field label="客户工号" placeholder="系统自动带出" v-model="customerEmployeeNo" disabled></mt-field>
            <mt-field label="入职日期" placeholder="系统自动带出" v-model="organizationalId" disabled></mt-field>
            <mt-field label="离职日期" placeholder="请选择" v-model="entryAt" @focus.native.capture="openPicker(0)"></mt-field>
            <mt-field label="离职原因" placeholder="请填写" v-model="positionType"></mt-field>
            <mt-field label="开始缴纳社保月份" placeholder="系统自动带出" v-model="entryAt1" @focus.native.capture="openPicker(1)"></mt-field>
            <mt-field label="最后缴纳社保月份" placeholder="请选择" v-model="entryAt2"  @focus.native.capture="openPicker(2)"></mt-field>
            <div class="footer">
